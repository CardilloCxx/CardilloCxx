...
public:
    ...
    void populate(cardillo::physics::PhysicsEngine& engine) override {
        ...
        auto cube2 = engine.addRigidBody(            physics::CubeShape(Vector3r(0.05,0.05,0.05)),
            physics::RigidState(Vector3r(cubeHalfExt + 0.05, cubeHalfExt + 0.05, cubeHalfExt + 0.05), m_cube, sys.ecs()),
            physics::RigidProps::withDensity(2500.0)
        );

        sys.addRigidConstraint(m_cube, cube2);
        ...
        K_trans(2) = 1000;
        sys.addTranslationalConstraint(m_cube, cube3, physics::JointFrame(cube3), K_trans);
        ...
        K_trans(1) = 1000;
        sys.addTranslationalConstraint(m_cube, cube4, physics::JointFrame(cube4), K_trans);
        ...
        K_trans = Vector3r::Constant(std::numeric_limits<real_t>::infinity());
        K_trans(0) = 1000;
        sys.addTranslationalConstraint(m_cube, cube5, physics::JointFrame(cube5), K_trans);
        ...
        K_trans = Vector3r::Constant(std::numeric_limits<real_t>::infinity());
        sys.addTranslationalConstraint(m_cube, cube6, 
        ...
        auto plate = engine.addRigidBody(            physics::CubeShape(Vector3r(0.3,0.3,0.02)),
            physics::RigidState(Vector3r(0,0,cubeHalfExt + 0.02 + 0.05), m_cube, sys.ecs()),
            physics::RigidProps::withDensity(2500.0)
        );
        sys.addHingeConstraint(m_cube, plate, 
        ...
        auto cube7 = engine.addRigidBody(            physics::CubeShape(Vector3r(0.05,0.05,0.05)),
            physics::RigidState(Vector3r(0.2,0.2,0.05), plate, sys.ecs()),
            physics::RigidProps::withDensity(2500.0)
        );
        sys.addRigidConstraint(plate, cube7);
        ...
        auto wall1 = engine.addRigidBody(            physics::CubeShape(Vector3r(wallHeight, wallLength, wallThickness)),
            physics::RigidState(Vector3r(cubeHalfExt + wallHeight, 0, wallLength), m_cube, sys.ecs()),
            physics::RigidProps::withDensity(2500.0)
        );
        sys.addRigidConstraint(m_cube, wall1);
        ...
        sys.addRigidConstraint(m_cube, wall2);
        ...
        auto wall3 = engine.addRigidBody(            physics::CubeShape(Vector3r(wallHeight, wallThickness, wallLength)),
            physics::RigidState(Vector3r(cubeHalfExt + wallHeight, wallLength, 0), m_cube, sys.ecs()),
            physics::RigidProps::withDensity(2500.0)
        );
        sys.addRigidConstraint(m_cube, wall3);
        ...
        auto wall4 = engine.addRigidBody(            physics::CubeShape(Vector3r(wallHeight, wallThickness, wallLength)),
            physics::RigidState(Vector3r(cubeHalfExt + 0.05, -wallLength, 0), m_cube, sys.ecs()),
            physics::RigidProps::withDensity(2500.0)
        );
        sys.addRigidConstraint(m_cube, wall4);
        sys.disableCollisionBetween(m_cube, wall4);

        auto cube8 = engine.addRigidBody(            physics::CubeShape(Vector3r(0.05,0.05,0.05)),
            physics::RigidState(Vector3r(cubeHalfExt + 0.05 + 0.01, 0, 0), m_cube, sys.ecs()),
            physics::RigidProps::withDensity(2500.0)
        );
        sys.addTranslationalConstraint(m_cube, cube8, physics::JointFrame(cube8),
            Vector3r(std::numeric_limits<real_t>::infinity(), 100, 100)
        );
        sys.addRotationConstraint(m_cube, cube8, physics::JointFrame(cube8));
        ...
        sys.addHingeConstraint(topSphere, midSphere,
        ...
        sys.addHingeConstraint(midSphere, bottomSphere,
            physics::JointFrame::fromAxis(
        ...
        sys.addHingeConstraint(floor,  m_lever_1,
            physics::JointFrame::fromAxis(
        ...
        sys.addHingeConstraint(floor, m_lever_2,
            physics::JointFrame::fromAxis(
        ...
        // Hinge at the left end of the lever, anchored in the world frame
        sys.addHingeConstraint(floor,  m_lever_3,
            physics::JointFrame::fromAxis(
        ...
        sys.addHingeConstraint(floor, m_lever_4,
            physics::JointFrame::fromAxis(
