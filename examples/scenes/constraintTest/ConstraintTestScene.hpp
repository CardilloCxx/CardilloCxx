...
// 
//             // Body A
//             Vector3r posA = Vector3r(0, 0, 0);
//             Quaternion4r qA = Quaternion4r::Identity();
//             Vector3r vA = Vector3r::Zero();
//             Vector3r wA = Vector3r(0.0, 1.0, 0.0); // initial spin around z
//             entt::entity A = sys.addRigidBody(mass, posA, qA, vA, wA, shape);
// 
//             // Body B
//             const Vector3r he = shape.halfExtents;
//             Vector3r posB = Vector3r(2.0 * he.x(), 2.0 * he.y(), 2.0 * he.z()); // offset so corners meet
...
//         }
        ...
        // Double pendulum
        {
            ...
            // Body C
            Vector3r posC = Vector3r(-3.0, 0.0, 1.0);
            Quaternion4r qC = Quaternion4r::Identity();
            Vector3r vC = Vector3r::Zero();
