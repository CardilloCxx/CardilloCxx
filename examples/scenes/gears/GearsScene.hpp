...
public:
    ...
    void populate(cardillo::physics::PhysicsEngine& engine) override {
        ...
        // gear system 1
        {
            ...
            engine.addHingeConstraint(floor, m_gear1, Vector3r(0,0,0), Vector3r(0,0,0), Vector3r(0,0,1));
            ...
            engine.addHingeConstraint(floor, gear2, Vector3r(0,0,0), Vector3r(0,0,0), Vector3r(0,0,1));
        }
        ...
        // gear system 2
        {
            ...
            engine.addHingeConstraint(floor, gear3, Vector3r(0,0,0), Vector3r(0,0,0), Vector3r(0,1,0));
            ...
            engine.addHingeConstraint(floor, m_gear4, Vector3r(0,0,0), Vector3r(0,0,0), Vector3r(0,0,1));
        }
        ...
        // gear system 3
        {
            ...
            engine.addHingeConstraint(floor, m_gear5, Vector3r(0,0,0),  rot5 * Vector3r(-0.055,-0.055, 0), Vector3r(0,0,1));
            ...
            engine.addHingeConstraint(floor, gear6, Vector3r(0,0,0), rot6 * Vector3r(-0.05,0.05, 0), Vector3r(0,0,1));
        }
        ...
        // gear system 4
        {
            ...
            engine.addHingeConstraint(floor, gear7, Vector3r(0,0,0), rot7 * Vector3r(-0.015,0.07,0), Vector3r(0,0,1), 50, 1);
            ...
            engine.addHingeConstraint(floor, m_gear8, Vector3r(0,0,0), rot8 * Vector3r(0,0,0), Vector3r(0,0,1));
        }
        ...
        // gear system 5
        {
            ...
            engine.addHingeConstraint(floor, gear10, Vector3r(0,0,0), Vector3r(0,0,0), Vector3r(0,0,1));
            ...
            engine.addHingeConstraint(floor, m_gear9, Vector3r(0,0,0), Vector3r(0,0,0), Vector3r(0,0,1));
        }
        ...
        // gear system 6
        {
            ...
            engine.addHingeConstraint(floor, m_gear10, Vector3r(0,0,0), Vector3r(0,0,0), Vector3r(0,0,1));
            ...
            engine.addHingeConstraint(floor, gear11, Vector3r(0,0,0), Vector3r(0,0,0), Vector3r(0,0,1));
        }
        ...
        // gear system 7
        {
            ...
            engine.addHingeConstraint(floor, m_gear12, Vector3r(0,0,0), rot12 * Vector3r(0.022,-0.012,0), Vector3r(0,0,1));
            ...
            engine.addHingeConstraint(floor, gear13, Vector3r(0,0,0), rot13 * Vector3r(-0.019,0.01,0), Vector3r(0,0,1));
        }
    }
