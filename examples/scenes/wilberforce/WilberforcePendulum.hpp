...
public:
    ...
    void populate(cardillo::PhysicsSystem& sys) override {
        ...
        const size_t turns = 3;                          // helical turns count
        ...
        auto linear2 = misc::LinearSpline( Vector3r(0, 0, -freeLength), Vector3r(0, 0, -freeLength -sizeZ));
        ...
        // m_bob = sys.addRigidBody(PhysicsSystem::CubeShape(Vector3r(sizeX, sizeY, sizeZ)),
