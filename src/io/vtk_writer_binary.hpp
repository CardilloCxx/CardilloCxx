...
class VtkWriterBinary {
   ...
   private:
    ...
    void writePointsBlock(std::ofstream& out, const std::vector<EntityMesh>& meshes) const;
    ...
    void writeDynamicGeometry(int step, const std::vector<EntityMesh>& meshes) const;
