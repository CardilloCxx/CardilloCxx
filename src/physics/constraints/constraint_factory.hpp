...
public:
    static size_t addLinearDistanceConstraint(World& world,
                                              entt::entity a,
                                              entt::entity b,
        ...
        return insertPattern(world, std::unique_ptr<ConstraintPattern>(
            new LinearDistanceConstraint(world.ecs(), a, b, rA_local, rB_local, stiffness, damping)));
    }
    ...
    static size_t addRigidConstraint(World& world,
        ...
        return insertPattern(world, std::unique_ptr<ConstraintPattern>(
            new TranslationRotationConstraint(world.ecs(), a, b, frame, K_trans, Vector3r::Zero(), K_rot, Vector3r::Zero())));
    }

    static size_t addTranslationRotationConstraint(World& world,
                                                   entt::entity a,
                                                   entt::entity b,
        ...
        return insertPattern(world, std::unique_ptr<ConstraintPattern>(
            new TranslationRotationConstraint(world.ecs(), a, b, frame, K_trans, D_trans, K_rot, D_rot)));
    }

    static size_t addTranslationalConstraint(World& world,
                                             entt::entity a,
                                             entt::entity b,
                                             const JointFrame& frame,
                                             const Vector3r& K_trans = Vector3r::Constant(std::numeric_limits<real_t>::infinity()),
    ...
    static size_t addRotationConstraint(World& world,
                                        entt::entity a,
                                        entt::entity b,
                                        const JointFrame& frame,
                                        const Vector3r& K_rot = Vector3r::Constant(std::numeric_limits<real_t>::infinity()),
    ...
    static size_t addHingeConstraint(World& world,
                                     entt::entity a,
                                     entt::entity b,
                                     const JointFrame& frame,
